      ...
      this.enterOuterAlt(_localctx, 1)
      {
        ...
        do {
          ...
          (((_la - 54) & ~0x1f) === 0 &&
            ((1 << (_la - 54)) &
              ((1 << (SmlParser.UNOP - 54)) |
                (1 << (SmlParser.IDENTIFIER - 54)) |
                (1 << (SmlParser.PRIMITIVE - 54)) |
                (1 << (SmlParser.LIST - 54)) |
                (1 << (SmlParser.TUPLE - 54)))) !==
              0)
        )
      }
    } catch (re) {
    ...
    try {
      this.enterOuterAlt(_localctx, 1)
      {
        ...
        do {
          ...
          (_la & ~0x1f) === 0 &&
          ((1 << _la) & ((1 << SmlParser.VAL) | (1 << SmlParser.LOCAL) | (1 << SmlParser.FUN))) !==
            0
        )
        this.state = 70
...
export class LocalBlockContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return SmlParser.RULE_localBlock
  }
  // @Override
  public enterRule(listener: SmlListener): void {
...
export class ConditionalContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return SmlParser.RULE_conditional
  }
  // @Override
  public enterRule(listener: SmlListener): void {
...
export class LetBlockContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return SmlParser.RULE_letBlock
  }
  // @Override
  public enterRule(listener: SmlListener): void {
...
export class PatternMatchContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return SmlParser.RULE_patternMatch
  }
  // @Override
  public enterRule(listener: SmlListener): void {
...
export class LiteralExpressionContext extends ExpressionContext {
  public PRIMITIVE(): TerminalNode {
    return this.getToken(SmlParser.PRIMITIVE, 0)
  }
...
export class TupleExpressionContext extends ExpressionContext {
  public TUPLE(): TerminalNode {
    return this.getToken(SmlParser.TUPLE, 0)
  }
  constructor(ctx: ExpressionContext) {
    super(ctx.parent, ctx.invokingState)
    this.copyFrom(ctx)
...
export class ListExpressionContext extends ExpressionContext {
  public LIST(): TerminalNode {
    return this.getToken(SmlParser.LIST, 0)
  }
  constructor(ctx: ExpressionContext) {
    super(ctx.parent, ctx.invokingState)
    this.copyFrom(ctx)
