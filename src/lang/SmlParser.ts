...
export class SmlParser extends Parser {
	public static readonly VAL = 1;
	public static readonly LET = 2;
	public static readonly LOCAL = 3;
	public static readonly IN = 4;
	public static readonly END = 5;
	public static readonly FUN = 6;
	public static readonly FN = 7;
	public static readonly DOUBLE_ARROW = 8;
	...
	public static readonly NEXT_PATTERN = 15;
	public static readonly TYPE_INT = 16;
	public static readonly TYPE_REAL = 17;
	public static readonly TYPE_STRING = 18;
	public static readonly TYPE_CHAR = 19;
	public static readonly TYPE_BOOL = 20;
	public static readonly TYPE_UNIT = 21;
	public static readonly TYPE_LIST = 22;
	public static readonly SINGLE_ARROW = 23;
	public static readonly SIGNATURE = 24;
	public static readonly SIG = 25;
	public static readonly STRUCTURE = 26;
	public static readonly STRUCT = 27;
	public static readonly FUNCTOR = 28;
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		undefined, "'val'", "'let'", "'local'", "'in'", "'end'", "'fun'", "'fn'", 
		"'=>'", "'rec'", "'if'", "'then'", "'else'", "'case'", "'of'", "'|'", 
		"'int'", "'real'", "'string'", "'char'", "'bool'", "'unit'", "'list'", 
		"'->'", "'signature'", "'sig'", "'structure'", "'struct'", "'functor'", 
		"'('", "')'", "'{'", "'}'", "'['", "']'", "','", "';'", "':'", "'.'", 
		"'='", "'<>'", "'<'", "'<='", "'>'", "'>='", "'~'", "'^'", "'*'", "'/'", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		undefined, "VAL", "LET", "LOCAL", "IN", "END", "FUN", "FN", "DOUBLE_ARROW", 
		...
		"SUB", "INT", "REAL", "BOOL", "UNIT", "CHAR", "STRING", "IDENTIFIER", 
		"IDENTIFIER_TUPLE", "WHITESPACE", "LIST_NIL", "LIST_CONSTRUCT", "LIST_CONCAT",
	];
	...
	public start(): StartContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SmlParser.VAL) | (1 << SmlParser.LET) | (1 << SmlParser.LOCAL) | (1 << SmlParser.FUN) | (1 << SmlParser.FN) | (1 << SmlParser.IF) | (1 << SmlParser.CASE) | (1 << SmlParser.L_PAREN))) !== 0) || ((((_la - 33)) & ~0x1F) === 0 && ((1 << (_la - 33)) & ((1 << (SmlParser.L_BRACKET - 33)) | (1 << (SmlParser.NEGATE - 33)) | (1 << (SmlParser.INT - 33)) | (1 << (SmlParser.REAL - 33)) | (1 << (SmlParser.BOOL - 33)) | (1 << (SmlParser.UNIT - 33)) | (1 << (SmlParser.CHAR - 33)) | (1 << (SmlParser.STRING - 33)) | (1 << (SmlParser.IDENTIFIER - 33)) | (1 << (SmlParser.LIST_NIL - 33)))) !== 0));
			}
		}
		catch (re) {
	...
	public static readonly _serializedATN: string =
		...
		"\x03\v\x03\v\x03\v\x06\v\x9C\n\v\r\v\x0E\v\x9D\x03\v\x03\v\x03\v\x03\v" +
		"\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x07\v\xAB\n\v\f\v\x0E\v\xAE" +
		"\v\v\x03\v\x03\v\x03\v\x05\v\xB3\n\v\x03\v\x03\v\x03\v\x03\v\x07\v\xB9" +
		"\n\v\f\v\x0E\v\xBC\v\v\x03\f\x03\f\x03\f\x03\f\x03\f\x03\r\x03\r\x03\r" +
		"\x03\r\x03\r\x03\r\x03\r\x03\r\x03\r\x03\r\x03\r\x05\r\xCE\n\r\x03\r\x03" +
		"\r\x03\r\x03\r\x03\r\x03\r\x03\r\x03\r\